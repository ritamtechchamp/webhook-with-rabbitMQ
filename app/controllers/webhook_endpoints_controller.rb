class WebhookEndpointsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @webhook_endpoint.update(webhook_endpoint_params)
        format.html { redirect_to webhook_endpoint_url(@webhook_endpoint), notice: "Webhook endpoint was successfully updated." }
  ...
  private
    ...
    def webhook_endpoint_params
      params.require(:webhook_endpoint).permit(:client_name, :api_url, :secret)
    end
end
