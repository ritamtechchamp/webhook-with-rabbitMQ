...
class WebhookEndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webhook_endpoint" do
    assert_difference("WebhookEndpoint.count") do
      post webhook_endpoints_url, params: { webhook_endpoint: { api_url: @webhook_endpoint.api_url, client_name: @webhook_endpoint.client_name, secret: @webhook_endpoint.secret } }
    end
  ...
  test "should update webhook_endpoint" do
    patch webhook_endpoint_url(@webhook_endpoint), params: { webhook_endpoint: { api_url: @webhook_endpoint.api_url, client_name: @webhook_endpoint.client_name, secret: @webhook_endpoint.secret } }
